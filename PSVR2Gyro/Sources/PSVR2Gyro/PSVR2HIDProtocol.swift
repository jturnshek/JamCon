...
/// PSVR2 Sense Controller HID Protocol Constants
/// See docs/PSVR2-HID-Protocol.md for full documentation
enum PSVR2HIDProtocol {
    ...
    enum OutputReport {
        ...
        // LED settings offsets (DualSense-style, may differ for PSVR2)
